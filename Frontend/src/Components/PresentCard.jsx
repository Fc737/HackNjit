...
import presentGoggles from '../images/presentGoggles.png';
import border from '../images/border.webp'; // Ensure you have the border image imported

const PresentCard = () => {
  const title = "Present";
  const subtitle = "(of today)";
  const description = [
    "The era of goggles, industrial",
    "fashion, and prosthetics"
  ];
  const image = presentGoggles;
  const link = "/timeline/present";
    ...
    <Box sx={{ minWidth: 300 }}>
      ...
      >
        <CardContent sx={{ textAlign: 'center' }}> 
          ...
          <img
            src={image}
            alt="Present Goggles" // Added alt attribute for accessibility
            width="200"
            height="200"
